...
public class StationWeatherServiceImpl implements StationWeatherService {
    ...
    private List<StationWeatherPerYear> calculateHoles(List<StationWeatherPerYear> completed) {
        ...
        for (int i = 0; i < completed.size(); i++) {
            ...
            if (t.getFebruar().compareTo(NULL_TEMPERATURE) == 0)
                t.setFebruar(getAverageTemperatur(completed, FEBRUAR, i));
            ...
            if (t.getSeptember().compareTo(NULL_TEMPERATURE) == 0)
                t.setSeptember(getAverageTemperatur(completed, SEPTEMBER, i));
            if (t.getOktober().compareTo(NULL_TEMPERATURE) == 0)
                t.setOktober(getAverageTemperatur(completed, OCTOBER, i));
            if (t.getNovember().compareTo(NULL_TEMPERATURE) == 0)
                t.setNovember(getAverageTemperatur(completed, NOVEMBER, i));
            if (t.getDezember().compareTo(NULL_TEMPERATURE) == 0)
                t.setDezember(getAverageTemperatur(completed, DEZEMBER, i));
    ...
    private BigDecimal getAverageTemperatur(List<StationWeatherPerYear> completed, String month, int index) {
        ...
        for (int i = start; i <= end; i++) {
            ...
            switch (month) {
                ...
                case JANUAR:
                    if (!completed.get(i).getJanuar().equals(NULL_TEMPERATURE)) {
                        result = result.add(completed.get(i).getJanuar());
                        counter++;
                    }
                    break;
                case FEBRUAR:
                    if (!completed.get(i).getFebruar().equals(NULL_TEMPERATURE)) {
                        result = result.add(completed.get(i).getFebruar());
                        counter++;
                    }
                    break;
                case MAERZ:
                    if (!completed.get(i).getMaerz().equals(NULL_TEMPERATURE)) {
                        result = result.add(completed.get(i).getMaerz());
                        counter++;
                    }
                    break;
                case APRIL:
                    if (!completed.get(i).getApril().equals(NULL_TEMPERATURE)) {
                        result = result.add(completed.get(i).getApril());
                        counter++;
                    }
                    break;
                case MAI:
                    if (!completed.get(i).getMai().equals(NULL_TEMPERATURE)) {
                        result = result.add(completed.get(i).getMai());
                        counter++;
                    }
                    break;
                case JUNI:
                    if (!completed.get(i).getJuni().equals(NULL_TEMPERATURE)) {
                        result = result.add(completed.get(i).getJuni());
                        counter++;
                    }
                    break;
                case JULI:
                    if (!completed.get(i).getJuli().equals(NULL_TEMPERATURE)) {
                        result = result.add(completed.get(i).getJuli());
                        counter++;
                    }
                    break;
                case AUGUST:
                    if (!completed.get(i).getAugust().equals(NULL_TEMPERATURE)) {
                        result = result.add(completed.get(i).getAugust());
                        counter++;
                    }
                    break;
                case SEPTEMBER:
                    if (!completed.get(i).getSeptember().equals(NULL_TEMPERATURE)) {
                        result = result.add(completed.get(i).getSeptember());
                        counter++;
                    }
                    break;
                case OCTOBER:
                    if (!completed.get(i).getOktober().equals(NULL_TEMPERATURE)) {
                        result = result.add(completed.get(i).getOktober());
                        counter++;
                    }
                    break;
                case NOVEMBER:
                    if (!completed.get(i).getNovember().equals(NULL_TEMPERATURE)) {
                        result = result.add(completed.get(i).getNovember());
                        counter++;
                    }
                    break;
                case DEZEMBER:
                    if (!completed.get(i).getDezember().equals(NULL_TEMPERATURE)) {
                        result = result.add(completed.get(i).getDezember());
                        counter++;
                    }
                    break;
