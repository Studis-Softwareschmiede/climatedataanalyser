...
-- CREATE USER '***REMOVED-CREDENTIAL***'@'localhost' IDENTIFIED BY '***REMOVED-CREDENTIAL***'
--     WITH MAX_QUERIES_PER_HOUR 0
--              MAX_UPDATES_PER_HOUR 0
--              MAX_CONNECTIONS_PER_HOUR 0
--              MAX_USER_CONNECTIONS 0;
-- GRANT ALL PRIVILEGES ON climate.* TO '***REMOVED-CREDENTIAL***'@'localhost';
...
CREATE TABLE `month` (
  ...
  MESS_DATUM_BEGINN DATE DEFAULT NULL,
  MESS_DATUM_ENDE DATE DEFAULT NULL,
